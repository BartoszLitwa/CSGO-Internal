...
ImVec2 get_sidebar_size()
{
    ...
    constexpr auto size_w = padding * 1.0f + get_sidebar_item_width();
...
void RenderMiscTab()
{
    ...
    ImGui::BeginGroupBox("##body_content");
    {
		...
		ImGui::SliderInt("FOV:", &g_Options.fov, 50, 160);
		...
		if (g_Options.misc_ClanTag) {
			ImGui::InputText("ClanTag Changer", g_Options.misc_clantagString, IM_ARRAYSIZE(g_Options.misc_clantagString));
			if (ImGui::Button("Set ClanTag"))
				BunnyHop::ClantagChanger(g_Options.misc_clantagString);
		}
		ImGui::Checkbox("Name Changer", &g_Options.misc_nameChanger);
		if (g_Options.misc_nameChanger) {
			ImGui::InputText("Name Changer", g_Options.misc_NameString, IM_ARRAYSIZE(g_Options.misc_NameString));
			if (ImGui::Button("Set Name"))
				BunnyHop::NameChanger(g_Options.misc_NameString);
		}
        //ImGui::PopItemWidth();
...
void RenderSkinchangerTab()
{
	...
	ImGui::BeginGroupBox("##body_content");
	{
		...
		ImGui::NextColumn();
		ImGui::Checkbox("KnifeChanger", &g_Options.KnifeChanger_KnifeChanger);
...
void Menu::CreateStyle()
{
	...
	_style.Colors[ImGuiCol_Button] = ImVec4(0.0f, 0.0f, 1.f, 1.0f);
	_style.Colors[ImGuiCol_Header] = ImVec4(0.0f, 0.0f, 1.f, 1.0f);
	_style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.0f, 0.0f, 1.f, 1.0f);
